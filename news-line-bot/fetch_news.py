...
全体を通しての追加指示:
- {len(articles)}件のcomment全体のうち、1〜2件だけに、その記事の内容に絡めた「おやじギャグ」(ダジャレ)を自然に混ぜ込むこと。残りの記事には無理にダジャレを入れないこと(全部に入れるとしつこくなるため)
...
def build_message(body):
    header = (
        f"おはよう꙳⸌☆⸍꙳!ネットに引きこもって世間についていけてない、そこのネット廃人のきみのために、"
        f"今日のニュースを厳選してきてやったから、心してチェックしておけ꙳⸌☆⸍꙳\n"
